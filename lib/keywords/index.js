...
module.exports = {
  ...
  containsMinContainsMaxContainsFUTURE: require("./contains-minContains-maxContains-FUTURE"),
  ...
  dynamicRefFUTURE: require("./dynamicRefFUTURE"),
  enum: require("./enum"),
  ...
  propertyDependencies: require("./propertyDependencies"),
